define('ember-models-table/components/models-table', ['exports', 'ember', 'ember-models-table/utils/fmt', 'ember-models-table/templates/components/models-table', 'ember-models-table/-private/column'], function (exports, _ember, _emberModelsTableUtilsFmt, _emberModelsTableTemplatesComponentsModelsTable, _emberModelsTablePrivateColumn) {
  'use strict';
  ...
  exports['default'] = Component.extend({
    ...
    _setupColumns: function _setupColumns() {
      ...
      var nColumns = A(get(this, 'columns').map(function (column) {
        ...
        var c = _emberModelsTablePrivateColumn['default'].create(column);
